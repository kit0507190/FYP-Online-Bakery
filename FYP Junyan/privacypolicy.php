                ...
                <div class="privacy-content">
                    ...
                    <article class="privacy-section">
                        ...
                        <ul class="styled-list">
                            ...
                            <li><strong>Payment Processors:</strong> Secure gateways that handle your credit card data (we do not store your full card details).</li>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <a href="privacypolicy.php" class="active">Privacy Policy</a>
