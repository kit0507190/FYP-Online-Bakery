<?php
/**
 * add.address.php - 自动化同步逻辑与邮编验证版本
 */
session_start();
                ...
                <div class="info-card">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group-half required-field">
                            ...
                            <input type="text" name="address_postcode" id="address_postcode" class="form-input" 
                                   required placeholder="e.g., 75450" maxlength="5"
                    ...
                    <div class="form-group required-field">
                        ...
                        <textarea name="address_line" class="form-textarea" required rows="3" 
                                  placeholder="Unit no, Building, Street Name... (No need to include postcode or area)"></textarea>
                    </div>
