...
try {
    ...
    $query = "SELECT name, email, phone, credit, created_at FROM user_db WHERE id = ?";
    ...
    if ($user) {
        ...
        $credit = number_format($user['credit'], 2); 
            ...
            <div class="info-card">
                <div class="info-card-header">
                    ...
                    <div class="credit-badge">
                        ...
                        <span class="credit-value">RM <?php echo $credit; ?></span>
                    </div>
                </div>
