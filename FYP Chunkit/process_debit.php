...
<head>
    ...
    <style>
        ...
        .summary-item-row { display: flex; align-items: center; padding: 12px 0; border-bottom: 1px solid #f9f9f9; }
        .summary-item-img { width: 60px; height: 60px; object-fit: cover; border-radius: 8px; margin-right: 15px; border: 1px solid #eee; }
        .summary-item-info { flex: 1; display: flex; justify-content: space-between; align-items: center; }
        .summary-item-name { font-size: 13px; color: #444; font-weight: 600; max-width: 180px; }
        .summary-item-qty { font-size: 12px; color: #999; margin-top: 2px; }
        .summary-item-price { font-weight: 600; color: var(--primary); font-size: 14px; }
...
<body>
                ...
                <div class="right-column">
                    <div class="card">
                        ...
                        <div class="address-box" style="margin-top: 10px;">
                            ...
                            <div class="address-details">
                                ...
                                <div class="address-text" id="addressLabel">
                                    Loading address...
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <label class="method-item" id="label-debit">
                            ...
                            <img src="Visa.jpg" alt="Visa" class="payment-logo-img">
                        ...
                        <label class="method-item" id="label-tng">
                            ...
                            <img src="Touch_'n_Go_eWallet.png" alt="TNG" class="payment-logo-img">
                        ...
                        <label class="method-item" id="label-fpx">
                            ...
                            <img src="Logo-FPX.png" alt="FPX" class="payment-logo-img">
    ...
    <div id="addressRequiredModal" class="force-modal-overlay">
        <div class="force-modal-content">
            ...
            <p>You need to add a delivery address before you can proceed with your payment.</p>
            <a href="add.address.php" class="btn-go-address">Go to Add Address</a>
            <div onclick="document.getElementById('addressRequiredModal').style.display='none'" style="cursor:pointer; color:#aaa;">Maybe Later</div>
        </div>
    </div>
    ...
    <script>
        ...
        function validateCheckout() {
            ...
            if (checked.value === 'debitCard') {
                ...
                if (cardNum.length !== 16) { alert("Invalid card number."); return false; }
            }
            return true;
        }
